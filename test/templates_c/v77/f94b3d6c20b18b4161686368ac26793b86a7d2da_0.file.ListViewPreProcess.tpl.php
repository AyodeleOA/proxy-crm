...
function content_68742876718cb0_40552198 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="row main-container main-container-<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
">
		<?php $_smarty_tpl->_assignInScope('LEFTPANELHIDE', $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('leftpanelhide'));?>
				
		<div id="sidebar-essentials" class="col-md-2 sidebar-essentialss <?php if ($_smarty_tpl->tpl_vars['LEFTPANELHIDE']->value == '1') {?> hide <?php }?>">
...
?>
		...
		<div class="col-md-10 listViewPageDiv content-areaa <?php if ($_smarty_tpl->tpl_vars['LEFTPANELHIDE']->value == '1') {?> col-md-12 full-width <?php }?>" id="listViewContent">
