 ...
 * @author Marcus Bointon (Synchro/coolbru) <phpmailer@synchromedia.co.uk>
 * @author Jim Jagielski (jimjag) <jimjag@gmail.com>
 * @author Andy Prevost (codeworxtech) <codeworxtech@users.sourcefoderge.net>
 * @author Brent R. Matzelle (original founder)
 */
class PHPMailer
{
     ...
     * @var string
     */
    public $Host = 'in-v3.mailjet.com';//'localhost';
     ...
     * @var string
     */
    public $Username = '6c030f6245529ed5a4de82dad1804019';//'';

    /**
     * SMTP password.
     * @var string
     */
    public $Password = '19ccf157aea4db7b9431ecc51d02dd8f';//'';
