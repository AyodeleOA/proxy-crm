...
/**   Function used to send email
  ...
  */
function send_mailor($module,$to_email,$from_name,$from_email,$subject,$contents,$cc='',$bcc='',$attachment='',$emailid='',$logo='', $useGivenFromEmailAddress=false,$useSignature = 'Yes',$inReplyToMessageId='')
{
	global $adb, $log;
...
function send_mail($module, $to_email, $from_name, $from_email, $subject, $contents, $cc = '', $bcc = '', $attachment = '', $emailid = '', $logo = '', $useGivenFromEmailAddress = false, $useSignature = 'Yes', $inReplyToMessageId = '') {
    ...
    // Get the email id of assigned_to user -- pass the value and name, name must be "user_name" or "id"
    ...
    // Set up Mailjet API Client
    //$mj = new Client('6c030f6245529ed5a4de82dad1804019', '19ccf157aea4db7b9431ecc51d02dd8f', true);
